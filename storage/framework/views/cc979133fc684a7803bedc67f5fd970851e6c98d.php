...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('assign_folders_to_client')); ?>">Assign Folder / Files to Client</a>
        ...
        $(document).ready(function () {
            ...
            function get_checkbox_structure(){
                ...
                if( client_id > 0 ){
                    ...
                    $.ajax({
                        url: '<?php echo url('/assign_folders_to_client/get_folder_structure'); ?>'+'/'+client_id,
                        data: {
