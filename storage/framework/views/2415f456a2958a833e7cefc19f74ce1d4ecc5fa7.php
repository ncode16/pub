                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="user_name" id="user_name" placeholder="Enter User Name" class="form-control" value="<?php echo e($user_name); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="dir_2_name" id="dir_2_name" placeholder="Director 2 Name" class="form-control" value="<?php echo e($dir_2_name); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="dir_2_contact_number" id="dir_2_contact_number" placeholder=" Director 2 Contact Number" class="form-control" value="<?php echo e($dir_2_contact_number); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="dir_2_email" id="dir_2_email" placeholder="Director 2 Email ID" class="form-control" value="<?php echo e($dir_2_email); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="acc_2_name" id="acc_2_name" placeholder="Accountant 2 Name" class="form-control" value="<?php echo e($acc_2_name); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="acc_2_contact_number" id="acc_2_contact_number" placeholder="Accountant 2 Contact Number" class="form-control" value="<?php echo e($acc_2_contact_number); ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="acc_2_email" id="acc_2_email" placeholder="Accountant 2 Email ID" class="form-control" value="<?php echo e($acc_2_email); ?>" required>
                                        </div>
                                    </div>
