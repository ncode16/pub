...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('admin/contact')); ?>">Contact Us</a>
                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo e(url('admin/contact/update')); ?>" class="form-horizontal form-bordered" name="frmContactUs" id="frmContactUs" method="POST">
                            <?php echo csrf_field(); ?>
                                <input type="hidden" name="contact_us_id" id="$contact_us_id" value="<?php echo e($contact_us_id); ?>">
                                <div class="form-body">
