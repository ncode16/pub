...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('admin/interviewer')); ?>">Interviewee</a>
                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo e($action); ?> Interviewee </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            ?>
                            <form action="<?php echo e(url($url)); ?>" class="form-horizontal form-bordered" name="frmInterviewee" id="frmInterviewee" method="POST">
                            <?php echo csrf_field(); ?>
