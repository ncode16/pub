...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Sub Client Role</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Manage Sub Client Role</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="<?php echo e(url('client_role/add')); ?>" class="btn sbold green"> Add New
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                <a href="<?php echo e(url('client_role/edit/'.$value->id)); ?>">
                                                    <i class="icon-pencil"></i> Edit </a>
                                            </li>
                                            <li class="divider"> </li>
                                            <li>
                                                <a href="<?php echo e(url('client_role/delete/'.$value->id)); ?>" data-toggle="confirmation" data-original-title="Are you sure you want to delete ?">
                                            ...
                                            <li>
                                                ...
                                                ?>
                                                <a href="<?php echo e(url('client_role/change_status/'.$value->id.'/'.$status)); ?>">
