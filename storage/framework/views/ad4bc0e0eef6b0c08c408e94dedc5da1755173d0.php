...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                <img src="<?php echo e(asset('assets/images/CapActix-logo.jpg')); ?>" alt="" style="width:325px;" /> </a>
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo e(url('save_new_password')); ?>" method="post">
