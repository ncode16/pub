...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('/client/dashboard')); ?>">Home</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo e(url('client/dashboard')); ?>" class="form-horizontal form-bordered" name="frmSubClientManagement" id="frmSubClientManagement" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-body">
