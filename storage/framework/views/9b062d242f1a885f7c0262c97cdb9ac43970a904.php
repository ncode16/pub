...
<input type="hidden" value="1" name="pdf_no" class="form-control" id="pdf_no">
...
<script type="text/javascript">
    function reload_func() {
            window.location = "<?php echo e(url('client/split')); ?>"
        }
    $(document).ready(function () {
        ...
        $(document).on( "change",'select#client_id',function() {
            ...
            if( client_id>0 ){
                ...
                $.ajax({
                    url: '<?php echo url('/client/get_list_split_files'); ?>',
                    type: "POST",
                    data: {
        ...
        $(document).on( "click",'button#submit_button',function() {
            ...
            if( split_file_id>0 && client_id>0){
                ...
                $.ajax({
                    url: '<?php echo url('/client/split_files'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'client_id': client_id,
