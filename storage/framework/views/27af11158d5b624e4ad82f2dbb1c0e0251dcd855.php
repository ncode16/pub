...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Assign Folder/Files to Sub Client</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Assign Folder / Files to Sub Client</span>
                    </div>
                        ...
                        <?php if($assign_folders_to_client): ?>
                          <?php $__currentLoopData = $assign_folders_to_client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <?php echo e($value->sub_first_name." ".$value->sub_last_name); ?>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                <a href="<?php echo e(url('assign_folders_to_client/edit/'.$value->client_id.'/'.$value->sub_client_id)); ?>">
                                                    <i class="icon-pencil"></i> Edit </a>
                                            </li>
                                            <!-- <li class="divider"> </li> -->
                                            <li>
                                            <a href="<?php echo e(url('assign_folders_to_client/delete/'.$value->sub_client_id.'/'.$value->client_id)); ?>" data-toggle="confirmation" data-original-title="Are you sure you want to delete ?">
