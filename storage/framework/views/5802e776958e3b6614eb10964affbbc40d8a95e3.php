...
<nav class="navbar navbar-expand justify-content-center justify-content-md-end">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'home') !== false) echo 'active';?>" href="<?php echo e(url('/')); ?>"><i class="icon-multiple-users-silhouette d-block d-md-none"></i><span class="d-none d-md-inline-block">About Us</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?php if(strpos($url, 'service') !== false) echo 'active';?>" href="<?php echo e(url('service')); ?>"><i class="icon-shopping-list d-block d-md-none"></i><span class="d-none d-md-inline-block">Services</span></a>
    </li>
<?php if(!empty(session('user_name'))){ ?>
    <li class="nav-item">
      <a class="nav-link  <?php if(strpos($url, 'interview') !== false) echo 'active';?>" href="<?php echo e(url('interview/1')); ?>"><i class="icon-manager d-block d-md-none"></i><span class="d-none d-md-inline-block">New interview</span></a>
    </li>
<?php  } ?>
<?php if(empty(session('user_name'))){ ?>
    <li class="nav-item">
