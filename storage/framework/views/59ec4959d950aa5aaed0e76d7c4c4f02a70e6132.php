                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo e(url('email_templates/update')); ?>" class="form-horizontal form-bordered" name="frmEmployeeManagement" id="frmEmployeeManagement" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                <div class="form-body">
                                    <div class="form-group last">
                                        <label class="control-label col-md-3">Upload Files</label>
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="upload_files" id="upload_files" rows="6"><?php echo e($upload_files); ?> </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="delete_folders" id="delete_folders" rows="6"><?php echo e($delete_folders); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="delete_files" id="delete_files" rows="6"><?php echo e($delete_files); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="rename_folders" id="rename_folders" rows="6"><?php echo e($rename_folders); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="rename_files" id="rename_files" rows="6"><?php echo e($rename_files); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="move_folders" id="move_folders" rows="6"><?php echo e($move_folders); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="move_files" id="move_files" rows="6"><?php echo e($move_files); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" name="signature" id="signature" rows="6"><?php echo e($signature); ?></textarea>
                                        </div>
                                    </div>
