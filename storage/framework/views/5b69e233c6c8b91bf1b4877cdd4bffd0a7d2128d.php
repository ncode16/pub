...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('assign_folders_to_client')); ?>">Assign Folder / Files to Sub Client</a>
                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo e($action); ?> Assign Folder / Files to Sub Client</div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php
                            if($action == "Add"){
                                $url = 'assign_folders_to_client/insert';
                            }else{
                                $url = 'assign_folders_to_client/update';
                            }
                            ?>
                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <input type="hidden" name="txt_sub_client_id" id="
                                txt_sub_client_id" value="<?php echo e($sub_client_id); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="sub_client_id" id="sub_client_id" <?php if($action=='Edit'): ?> disabled <?php endif; ?> >
...
<script src="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on( "change",'select#sub_client_id',function() { 
                get_client();
            });
            ...
            function get_client(){
                $.ajax({
                    url: '<?php echo url('/assign_folders_to_client/get_client'); ?>'+'/'+$("select#sub_client_id").val(),
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'sub_client_id': $("select#sub_client_id").val(),
                    },
                    type: "GET",
            ...
            $('#client_id').click(function(){
                $.ajax({
                    url: '<?php echo url('/assign_folders_to_client/get_folder_structure'); ?>'+'/'+$("select#client_id").val()+'/'+$("select#sub_client_id").val(),
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
