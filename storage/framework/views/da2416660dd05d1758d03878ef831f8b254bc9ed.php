...
<script type="text/javascript">
    function reload_func() {
            window.location = "<?php echo e(url('client/merge')); ?>"
        }
    ...
    $(document).ready(function () {
        ...
        function get_files_to_merge(folder_id){
            ...
            if(folder_id>0){
                ...
                $.ajax({
                    url: '<?php echo url('/client/get_files_to_merge'); ?>',
                    type: "POST",
                    data: {
        ...
        $("div.move_files").show();
                ...
                $.ajax({
                    url: '<?php echo url('/margec/get_list_move_files_from'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'action': 'move_files',
                ...
                $.ajax({
                    url: '<?php echo url('/margec/get_list_move_files_to'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'action': 'move_files',
        ...
        $(document).on( "click",'button#submit_button',function() {
            ...
            if(client_id>0){
                ...
                $.ajax({
                    url: '<?php echo url('/client/merge_files'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'client_id': client_id,
