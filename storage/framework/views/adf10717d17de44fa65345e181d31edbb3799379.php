                        ...
                        <div class="portlet-body form">
                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group upload_folder_div  upload_folder_div_check" id="" style="display: none;">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		formData.append('check_val', check_val);
                ...
                if(error==""){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data.sts==1){
				 $("div#display_errors .success").html(data.check);
                                $("div#display_errors .success").html(data.msg);
                                $("div#display_errors").show();
                            }else if(data.sts==2){
                                 location.reload();				
        ...
        $(document).on( "click",'.open_doc_model1',function() {
