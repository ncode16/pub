...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body" id="next_pdf" style="height: 700px !important;">
          ...
          <!--  <embed id="view_doc_model" src="" width="100%" height="400px;" style="height: 100% !important;"> -->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#client_id').on('change',function(){
            ...
            $.ajax({
                    url: '<?php echo url('/cl_document_mngt/get_emp_permission'); ?>',
                    type: "POST",
                    data: {
        ...
        $(document).on( "change",'select.select_sub_folder',function() { 
            ...
            if( client_id>0 ){
                ...
                $.ajax({
                    url: '<?php echo url('/cl_document_mngt/get_client_folder'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'action': action,
        ...
        $(document).on( "click",'.open_doc_model',function() {
            ...
            data += "<small><a href=<?php echo e(url('/client/document_mngt?action=delete_files&client_id=')); ?>"+client_id+" target='_blank'>Delete Files</a></small><small>";

            <?php endif; ?>

            <?php if( !empty($show_emp_roles) && array_key_exists('rename_files',$show_emp_roles) ): ?>

            data += " | <a href=<?php echo e(url('/client/document_mngt?action=rename_files&client_id=')); ?>"+client_id+" target='_blank'>Rename Files</a></small><small>";

            <?php endif; ?>

            <?php if( !empty($show_emp_roles) && array_key_exists('archive_files',$show_emp_roles) ): ?>

            data += " | <a href=<?php echo e(url('/client/document_mngt?action=archive_files&client_id=')); ?>"+client_id+" target='_blank'>Archive Files</a></small><small>";
            ...
            data += " | <small><a href='javascript:void(0)' id='upload_by_client' class='direct_move_file_link1'>Upload by client</a></small>";

            data += " | <small><a href='javascript:void(0)' id='posted' class='direct_move_file_link1'>Posted</a></small>";
            ...
            data += "<br/><small class='text-danger' id='modal_url_path'>"+$(this).attr('data-url')+"</small>";
        ...
        $(document).on( "click",'.model_next_file_link',function() {
            ...
            $.ajax({
                url: '<?php echo url('/cl_document_mngt/get_next_list'); ?>',
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    'client_id': client_id,
                ...
                success: function(data) {
                    ...
                    if(data==""){
                        $("#next_prev_msg").html("No Files Available");
                        /*model_move_folder_id = 0;*/
                        $("#view_read_doc").modal('show');
                        /*$("#view_doc_model").attr('src',"");
                        $('#modal_url_path').html("");
                        $('#next_pdf').html("");*/
                    }else{
                        
                        $('#next_pdf').html(data.html);
                        model_move_folder_id = data.folder_id;
                        $("#view_read_doc").modal('show');
                        $("#view_doc_model").attr('data-folder_id',data.folder_id);

                        $('#next_prev_parent_id').val(data.parent_id);
                        $('#modal_url_path').html(data.path);
                    }
        ...
        $(document).on( "click",'.model_pre_file_link',function() {
            ...
            $.ajax({
                url: '<?php echo url('/cl_document_mngt/get_pre_list'); ?>',
                type: "POST",
                data: {
                    "_token": "<?php echo e(csrf_token()); ?>",
                    'client_id': client_id,
        ...
        $(document).on( "click",'.direct_move_file_link',function() {
            ...
            var reason;
            var reason = prompt("Please Enter Reason for Move File", "");
            ...
            if(error==""&&client_id>0){
                ...
                $.ajax({
                    ...
                    url: '<?php echo url('/cl_document_mngt/direct_move_files'); ?>',
                    type: "POST",
                    data: {
                        "_token": "<?php echo e(csrf_token()); ?>",
                        'action':'move_files',
	 ...
	 $(document).on( "click",'.direct_move_file_link1',function() {
        ...
        <?php
            ...
            if( isset(request()->action) && isset(request()->client_id) && isset(request()->from) ){
                ...
                if(array_key_exists($action,$document_management)){
                    ...
                    $.ajax({
                        url: '<?php echo url('/cl_document_mngt/get_list_view_read_files_search'); ?>',
                        type: "POST",
                        data: {
                            "_token": "<?php echo e(csrf_token()); ?>",
                            'action': 'view_read_files',
