        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="javascript:void(0)" onClick="window.location.reload()">
                       <!-- <img src="<?php echo e($header_logo_url); ?>" alt="" style="height: 64px;width: 199px;margin: 0px 0px 0px !important; " class="logo-default" /> </a> -->
			<img src="<?php echo e($header_logo_url); ?>" alt="" style="height: 70px;width: 199px;margin: 0px 0px 0px !important; " class="logo-default" /> </a> 
				...
				<?php if (in_array("system_config", $marray) || session('activity_id') == 1)  { ?>
                                        <li>
                                            <a href="<?php echo e(url($system_config)); ?>">
			...
			<?php if (in_array("full_backup", $marray) || session('activity_id') == 1)  { ?>
                                    ...
                                    <?php // if(session('login_type') == 'admin'){ ?>
                                            <li>
                                                <a href="<?php echo e(url('full_backup')); ?>">
