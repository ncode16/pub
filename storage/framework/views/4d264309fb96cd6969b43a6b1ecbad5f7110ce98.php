...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('client_role')); ?>">Role</a>
                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="client_role" id="client_role" placeholder="Enter Role" class="form-control" value="<?php echo e($client_role); ?>">
