...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('admin/interviewer')); ?>">Interviewer</a>
                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo e($action); ?> Interviewer </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            ?>
                            <form action="<?php echo e(url($url)); ?>" class="form-horizontal form-bordered" name="frmInterviewer" id="frmInterviewer" method="POST">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="username" id="username" placeholder="Enter User Name" class="form-control" value="<?php echo e($username); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="password" id="password" placeholder="Enter Password" class="form-control" value="<?php echo e($password); ?>">
                                        </div>
                                    </div>
                                </div>
