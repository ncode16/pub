                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <?php if($value->status=='approved'): ?>
                                                ...
                                                <a href="<?php echo e(url('assign_folders_to_employee/delete/'.$value->client_id.'/'.$value->employee_id)); ?>" data-toggle="confirmation" data-original-title="Are you sure you want to delete ?">
                                                    <i class="icon-trash"></i> Delete </a>

                                            <?php elseif($value->status=='archived'): ?>
                                                <a href="<?php echo e(url('assign_folders_to_employee/restore/'.$value->id)); ?>" data-toggle="confirmation" data-original-title="Are you sure you want to restore ?">
                                            ...
                                            <li>
                                                ...
                                                ?>
                                                <a href="<?php echo e(url('assign_folders_to_employee/change_status/'.$value->id.'/'.$status)); ?>">
