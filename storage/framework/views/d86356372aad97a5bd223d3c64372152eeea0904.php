...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="<?php echo e(url('employee_role_permision')); ?>">Employee Role Permission</a>
                ...
                <div class="tab-pane active" id="tab_5">
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo e($action); ?> Employee Role Permission </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <!-- <div class="form-group">
                                        <label class="control-label col-md-3">Employee Role Permission*</label>
                                        <div class="col-md-9">
                                            <select class="form-control" name="permision[]" id="permision" multiple>
                                                <option value="">Select Employee Role Permission</option>
