...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo e(url('client/check_login')); ?>" method="post">
            <?php echo csrf_field(); ?>
                <h3 class="form-title font-green">Sub Client Sign In</h3>
            ...
            <form class="forget-form" action="<?php echo e(url('client/reset_password')); ?>" method="post">
