...
<h3>Deadline</h3>
    ...
    ?>
        ...
        <div class="form-group" style="margin-left: 25px;">
          ...
          <!-- <input type="hidden" class="form-control form-control-lg " name="deadlinedate" id="deadlinedate"  value="{{ $deadline }}"   /> -->
        </div>
...
<button type="button"  id="link-step-1" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}"></button>
...
<div id="step-2" style="display: none;" class="step">
  ...
  <div class="form-group text-right">
    <button type="button" class="btn btn-nxt" id="link-step-2" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}" style="max-width: none;"></button>
  </div>
  <div class="form-group text-left">
  *Mandatory fields
</div>
  ...
  @csrf
    ...
    <div class="detSection">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control form-control-lg" id="interview_article" name="interview_article" placeholder="E.g. Interview with Barack Obama, the superstar politician" value="{{ $interview_article }}">
      </div>
      <div class="form-group">
          <label class="fName">Subtitle (if any)</label>
          <input type="text" class="form-control form-control-lg" id="subtitle" name="subtitle" placeholder="E.g. Barack Obama is giving an interview to our media and…" value="{{ $subtitle }}">
      </div>
      <div class="form-group">
          <label class="fName">URL or website where interview will be published</label>
          <input type="text" class="form-control form-control-lg" id="interview_website" name="interview_website" placeholder="E.g. https//www.cnn.com/interview-obama-superstar-politician" value="{{ $interview_website }}">
      </div>
...
<div class="form-group text-right">
    <button type="button" class="btn btn-nxt" id="link-step-3" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}" style="max-width: none;"></button>
  </div>
</div>
<?php }else{ echo "<div>No Data</div>"; }?>
...
<div class="step" id="step-4">
  ...
  <div class="form-group text-right">
    <button type="button" class="btn btn-nxt" id="link-step-4" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}" style="max-width: none;"></button>
  </div>
</div>
<?php }else{ echo "<div>No Data</div>"; }?>
...
<div class="step" id="step-5">
  ...
  <div class="form-group text-right">
    <button type="button" class="btn btn-nxt" id="link-step-5" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}" style="max-width: none;"></button>
  </div>
</div>
<?php }else{ echo "<div>No Data</div>"; }?>
...
<div class="step" id="step-6">
  ...
  <div class="form-group text-right">
    <button type="button" class="btn btn-nxt" id="link-step-6" style="pointer-events: all;background: none !important;border:none !important"><img src="{{ asset('logo/right-arrow.png') }}" style="max-width: none;"></button>
  </div>
</div>
<?php }else{ echo "<div>No Data</div>"; }?>
</div>
